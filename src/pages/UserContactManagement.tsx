    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Manage your contact messages and responses
        </p>
      </div>
                      ...
                      <TableRow key={submission.id}>
                        ...
                        <TableCell>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => window.location.href = `/admin/contact-submission/${submission.id}`}
                          >
        ...
        <TabsContent value="settings" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure your contact form preferences and settings
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center p-8 text-muted-foreground">
                Contact form settings will be available here
              </div>
            </CardContent>
          </Card>
        </TabsContent>
