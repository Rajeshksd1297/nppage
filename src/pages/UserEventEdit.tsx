...
export default function UserEventEdit() {
  ...
  const fetchEvent = async () => {
    try {
      ...
      setOriginalEvent(data as Event);
      setFormData({
        title: data.title,
  ...
  if (settingsLoading || eventLoading) {
    return (
    ...
    return (
      <FeatureAccessGuard feature="events">
        <div className="text-center py-8">
          <p>Event not found</p>
          <Button onClick={() => navigate('/user-events-management')} className="mt-4">
